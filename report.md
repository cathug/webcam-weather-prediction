...
red, green, and blue layers using `add_image0()`
    ...
    ![Figure 1](../blob/master/fig1.png?raw=true)
...
using `add_image1()` 
    ...
    ![Figure 2](../blob/master/fig2.png?raw=true)
...
using `add_image4()`
    ...
    ![Figure 5](../blob/master/fig5.png?raw=true)
...
road, and sea subimages using `add_image5()` 
    ...
    ![Figure 6](../blob/master/fig6.png?raw=true)
